...
class DynaQBase {
 ...
 protected:
  ...
  rl::FLOAT _stateActionTransitionGreediness;  //!< How likely does the model picks
                                               //!< an action that will generate highest
                                               //!< value given a state.
  rl::FLOAT _stateActionTransitionStepSize;  //!< How fast does the model increment the
                                             //!< state-action value.
};
