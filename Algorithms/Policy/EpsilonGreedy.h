...
template<class S, class A>
const A& AI::Algorithm::EpsilonGreedy<S, A>::getAction(const map<A, AI::FLOAT>& actionValues,
	const set<A>& actionSet) {
...
template<class S, class A>
const A& AI::Algorithm::EpsilonGreedy<S, A>::argMax(const map<A, AI::FLOAT>& actionValues,
	const set<A>& actionSet) const {
