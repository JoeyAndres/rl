  ...
  namespace Algorithm {
	...
	public:
	  ...
	  void updateWeights(const vector<FLOAT>& stateVector,
		  const actionVector<FLOAT>& av, const vector<FLOAT>& nextState,
		  const FLOAT reward, const set<actionVector<FLOAT> >& actionSet);
	  void updateWeights(const vector<FLOAT>& currentStateVector,
		  const actionVector<FLOAT>& currentActionVector,
		  const vector<FLOAT>& nextStateVector, const vector<FLOAT>& nextAction,
		  const FLOAT reward);
	  void updateWeights(const vector<FLOAT>& currentStateVector,
		  const actionVector<FLOAT>& currentActionVector,
	  ...
	  void buildActionValues(const set<actionVector<FLOAT> >& actionSet,
	...
	void GradientDescent::updateWeights(const vector<FLOAT>& stateVector,
		const actionVector<FLOAT>& av, const vector<FLOAT>& nextState,
		const FLOAT reward, const set<actionVector<FLOAT> >& actionSet) {
	...
	inline void GradientDescent::updateWeights(
		...
		const vector<FLOAT>& nextActionVector, const FLOAT reward) {
