...
AI::StateActionNotExistException::StateActionNotExistException(string extraMessage) {
  _extraMessage = extraMessage;
}

const char* AI::StateActionNotExistException::what() const throw () {
  string concatenateExtraMessage = "StateAction pair does not exist." + _extraMessage;
