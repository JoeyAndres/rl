...
TEST(SarsaETGDInitialization) {
  DimensionInfo<AI::FLOAT> dimensionalInfo[] = {
	  DimensionInfo<AI::FLOAT>(-1.2F, 0.5F, 10), DimensionInfo<AI::FLOAT>(
		  -0.07F, 0.07F, 10), DimensionInfo<AI::FLOAT>(0.0F, 2.0F, 3),
  };

  vector<DimensionInfo<AI::FLOAT> > dimensionalInfoVector(
	  dimensionalInfo,
	  dimensionalInfo + sizeof(dimensionalInfo)
		  / sizeof(DimensionInfo<AI::FLOAT> ));
