...
TEST(SoftmaxInitialization) {
  ...
  stateActionPairValueMap[StateAction<AI::INT, AI::INT>(dummyState, action01)] = 1.0F;
  stateActionPairValueMap[StateAction<AI::INT, AI::INT>(dummyState, action02)] = 2.0F;
  stateActionPairValueMap[StateAction<AI::INT, AI::INT>(dummyState, action03)] = -1.0F;
  stateActionPairValueMap[StateAction<AI::INT, AI::INT>(dummyState, action04)] = 2.2F;
